      ...
      if (user.emailVerified) {
       firebase.firestore().collection("users").onSnapshot((users)=>{
        ...
        users.forEach((userdetail)=>{
           ...
           userimg.setAttribute("src", "https://images.rawpixel.com/image_png_social_square/cHJpdmF0ZS9sci9pbWFnZXMvd2Vic2l0ZS8yMDIzLTAxL3JtNjA5LXNvbGlkaWNvbi13LTAwMi1wLnBuZw.png")
           ...
           usercoverimg.setAttribute("src","https://img.freepik.com/fotos-premium/um-fundo-azul-e-roxo-com-um-fundo-roxo-que-diz-azul_873925-15986.jpg")
